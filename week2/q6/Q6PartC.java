...
public class Q6PartC {
    ...
    /*
     * Returns the name & gender of farmer who owns this plot of land. garden - the
     * specified community garden, assumed not null. plotNumber - the specified
     * plotNumber
     *
     * If the plotNumber is invalid, return "N.A." If the plot is currently vacant
     * (i.e. not owned by any farmer), return "available". Otherwise, return the
     * farmer's name and gender e.g. "Amy[Female]" e.g. "Bill[Male]"
     */
